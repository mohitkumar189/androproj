package com.example.mohitattri.visheshagyaexpert.constants;

/**
 * Created by mohitattri on 11/29/16.
 */

public interface AppConstants {

    //Shared Preferences Tags Constants
    ...
    public static final int RESPONCE_ERROR_422 = 422;
    public static final int RESPONCE_ERROR_400 = 400;
    public static final String RESPONCE_ERROR = "error";
    public static final String RESPONCE_MESSAGE = "message";
    public static final String BASE_URL = "http://visheshagya-dev.herokuapp.com/";

    public static final String BASE_URL_IMAGES = "http://mediainc.in/mediax_api/images/";

    public static final String SIGNUP_URL = BASE_URL + "api/auth/signup";
