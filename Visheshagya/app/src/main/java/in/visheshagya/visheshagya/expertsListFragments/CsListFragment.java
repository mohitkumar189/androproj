...
public class CsListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_cs_list, container, false);
    }
    ...
    public void onResume() {
        super.onResume();
        Log.d("fragment", "onResume() ca");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.d("fragment", "onPause() ca");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.d("fragment", "onStop ca");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.d("fragment", "onStart() ca");
    }

    private void downloadExpertsData() {
        String url = APIUrls.VISHESHAGYA_URL + APIUrls.SEARCH_EXPERTS + "expertCategoryId=" + 2 + "&offset=" + offset;
    ...
    private void setupExperts() {
        listViewExpert = (ListView) getActivity().findViewById(R.id.csListView);
        expertDataAdapter = new ExpertsDataAdapter(expertDataList, getActivity());
