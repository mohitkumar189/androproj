...
public class LawyersListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_lawyers_list, container, false);
    }
    ...
    private void downloadExpertsData() {
        String url = APIUrls.VISHESHAGYA_URL + APIUrls.SEARCH_EXPERTS + "expertCategoryId=" + 3 + "&offset=" + offset;
    ...
    private void setupExperts() {
        listViewExpert = (ListView) getActivity().findViewById(R.id.lawyerListView);
        expertDataAdapter = new ExpertsDataAdapter(expertDataList, getActivity());
