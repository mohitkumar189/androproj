...
public class PayuPaymentGateway extends Activity {
    ...
    private void initializeWebView() {
        ...
        mapParams.put("hash", PayuPaymentGateway.this.hash);
        mapParams.put("txnid", (empty(PayuPaymentGateway.this.params.get("txnid"))) ? "" : PayuPaymentGateway.this.params.get("txnid"));
        Log.d(tag, "txnid: " + PayuPaymentGateway.this.params.get("txnid"));
        mapParams.put("service_provider", "payu_paisa");

        mapParams.put("amount", (empty(PayuPaymentGateway.this.params.get("amount"))) ? "" : PayuPaymentGateway.this.params.get("amount"));
        mapParams.put("firstname", (empty(PayuPaymentGateway.this.params.get("firstname"))) ? "" : PayuPaymentGateway.this.params.get("firstname"));
        mapParams.put("email", (empty(PayuPaymentGateway.this.params.get("email"))) ? "" : PayuPaymentGateway.this.params.get("email"));
        mapParams.put("phone", (empty(PayuPaymentGateway.this.params.get("phone"))) ? "" : PayuPaymentGateway.this.params.get("phone"));

        mapParams.put("productinfo", (empty(PayuPaymentGateway.this.params.get("productinfo"))) ? "" : PayuPaymentGateway.this.params.get("productinfo"));
        mapParams.put("surl", (empty(PayuPaymentGateway.this.params.get("surl"))) ? "" : PayuPaymentGateway.this.params.get("surl"));
        mapParams.put("furl", (empty(PayuPaymentGateway.this.params.get("furl"))) ? "" : PayuPaymentGateway.this.params.get("furl"));
        mapParams.put("lastname", (empty(PayuPaymentGateway.this.params.get("lastname"))) ? "" : PayuPaymentGateway.this.params.get("lastname"));

        mapParams.put("address1", (empty(PayuPaymentGateway.this.params.get("address1"))) ? "" : PayuPaymentGateway.this.params.get("address1"));
        mapParams.put("address2", (empty(PayuPaymentGateway.this.params.get("address2"))) ? "" : PayuPaymentGateway.this.params.get("address2"));
        mapParams.put("city", (empty(PayuPaymentGateway.this.params.get("city"))) ? "" : PayuPaymentGateway.this.params.get("city"));
        mapParams.put("state", (empty(PayuPaymentGateway.this.params.get("state"))) ? "" : PayuPaymentGateway.this.params.get("state"));

        mapParams.put("country", (empty(PayuPaymentGateway.this.params.get("country"))) ? "" : PayuPaymentGateway.this.params.get("country"));
        mapParams.put("zipcode", (empty(PayuPaymentGateway.this.params.get("zipcode"))) ? "" : PayuPaymentGateway.this.params.get("zipcode"));
        mapParams.put("udf1", (empty(PayuPaymentGateway.this.params.get("udf1"))) ? "" : PayuPaymentGateway.this.params.get("udf1"));
        mapParams.put("udf2", (empty(PayuPaymentGateway.this.params.get("udf2"))) ? "" : PayuPaymentGateway.this.params.get("udf2"));

        mapParams.put("udf3", (empty(PayuPaymentGateway.this.params.get("udf3"))) ? "" : PayuPaymentGateway.this.params.get("udf3"));
        mapParams.put("udf4", (empty(PayuPaymentGateway.this.params.get("udf4"))) ? "" : PayuPaymentGateway.this.params.get("udf4"));
        mapParams.put("udf5", (empty(PayuPaymentGateway.this.params.get("udf5"))) ? "" : PayuPaymentGateway.this.params.get("udf5"));
        mapParams.put("pg", (empty(PayuPaymentGateway.this.params.get("pg"))) ? "" : PayuPaymentGateway.this.params.get("pg"));
        ...
        public void success(final long id, final String paymentId) {
            mHandler.post(new Runnable() {
                public void run() {
                    ...
                    Intent intent = new Intent(PayuPaymentGateway.this, AfterBookingStatus.class);
